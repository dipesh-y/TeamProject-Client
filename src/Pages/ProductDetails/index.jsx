            ...
            <section className="bg-white py-5">
                <div className="container flex gap-8 item-center">
                    ...
                    <div className="productContent w-[60%]">
                        ...
                        Chikankari Women Kurta with plazoo and dupatta in pink colour</h1>
                        <div className="flex items-center gap-3">
                            <span className="text-gray-400 text-[13px]">
                                Brands : <span className="font-[500] text-black opacity-75">
                                    House of Chikankari</span></span>
                           ...
                           <div className="QtyBoxWrapper w-[70px]">
                            <QtyBox/>
                               ...
                               <Button className="btn-org flex gap-2">
                                <MdOutlineShoppingCart calssName="text-[22px]"/>Add To Cart</Button>
                    </div>

                    <div className="flex items-center gap-4 mt-6">
        <span className="flex items=center gap-2 text-[15px] link cursor-pointer font-[500]">
            <FaRegHeart className="text-[20px]"/>Add To Wishlist</span>

            <span className="flex items=center gap-2 text-[15px] link cursor-pointer font-[500]">
            <IoGitCompareOutline className="text-[20px]"/>Add To Compare</span>
      </div>
                ...
                <div className="container pt-10">
                    <div className="flex items-center gap-8 mb-5">
                        <span className="link text-[17px] cursor-pointer font-[500] ${active===0 && `text-primary`}" 
                        onClick={()=>setActiveTab(0)}>
                            Description</span>
                        <span className="link text-[17px] cursor-pointer font-[500] ${active===1 && `text-primary`}"
                         onClick={()=>setActiveTab(1)}>
                            Product Details</span>
                        <span className="link text-[17px] cursor-pointer font-[500] ${active===2 && `text-primary`}"
                    ...
                    <div className="shadow-md w-full py-5 px-8  rounded-md">
                        <p>The best is yet to come! Give your walls a voice with a framed poster.
                             Painted wooden frame wieh passe-part out withmore depth</p>
                             <h4>Lightweight Design</h4>
                             <p>A lightweight design focuses on simplicity, efficiency, and clean aesthetics. 
                                It removes unnecessary visual noise, keeps elements minimal, 
                                and ensures every component serves a clear purpose. 
                                By reducing bulky layouts, heavy UI frameworks, and excessive styling, 
                                lightweight design improves performance and creates a smoother user experience. 
                                The result is a modern, clutter-free interface that feels fast, intuitive,
                                 and visually balanced—ideal for users who value speed, clarity, 
                                 and functionality without distraction.
                              </p>
                              <h4>Free Shipping and Return</h4>
                              <p>We offer free shipping for products on orders above 50$ and 
                                offer free delivery all order in us</p>
                                <h4>Money Back Guarantee</h4>
                                <p>We guarantee are products and you could back all off your 
                                    money anytime you want in 30 days</p>
                                    <h4>Online Support</h4>
                                    <p>You will get 24 hours support with this purchase product 
                                        and you can return it within 30 days for an exchange
                                    </p>
                                ...
                                <div className="reviews pt-5 pb-5 border-b border-[rgba(0,0,0,0.1)] w-full flex items-center justify-between">
                                    <div className="info w-[60%] flex items-center gap-3">
                                        <div className="img w-[80px] h-[80px] overflow-hidden rounded-full">
                                            ...
                                            2h8Mnx8dXNlcnxlbnwwfHwwfHx8MA%3D%3D" className="w-full"></img>
                                        </div>

                                        <div className="w-[70%]">
                                            <h4 className="text-[16px]">Rinku verma</h4>
                                            <h5 className="text-[13px] mb-0">2025-12-01</h5>
                                            <p className="mt-0 mb-0">Lorem Ipsum is simply dummy text of the printing 
