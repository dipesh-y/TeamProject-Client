  ...
  return (
    <section className="section py-10 pb-10">
      <div className="container w-[80%] max-w-[80%] flex gap-5">
        ...
        <div className="rightPart w-[30%] pl-5">
          <div className="shadow-md rounded-md bg-white p-5">
            ...
            <p className="flex items-center justify-between">
              <span className="font-[500] text-[14px]">Estimate for </span>
              <span className="font-bold text-primary">United Kingdom</span>
            </p>

            <p className="flex items-center justify-between">
              <span className="font-[500] text-[14px]">Total</span>
              <span className="font-bold text-primary">₹1,300.00</span>
            </p>
