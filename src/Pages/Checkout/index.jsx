                        ...
                        <form className='w-full mt-5'>
                            <div className='flex items-center gap-5 pt-2 pb-5'>
                                <div className='col w-[50%]'>
                                    <TextField className='w-full' id="outlined-basic" label='Full Name' variant='outlined' size='small' />
                                </div>
                            ...
                            <div className='flex items-center gap-5 pb-5'>
                                <div className='col w-[100%]'>
                                    <TextField className='w-full' id="outlined-basic" label='House No. and Street Name' variant='outlined' size='small' />
                                </div>
                            </div>
                            <div className='flex items-center gap-5 pb-5'>
                                <div className='col w-[100%]'>
                                    <TextField className='w-full' id="outlined-basic" label='Apatment, suite, unit, etc. (optional)' variant='outlined' size='small' />
                                </div>
                            </div>
                            <div className='flex items-center gap-5 pb-5'>
                                <div className='col w-[50%]'>
                            ...
                            <div className='flex items-center justify-between py-2'>
                                <div className='part1 flex items-center gap-3'>
                                    <div className='img w-[50px] h-[50px] object-cover overflow-hidden rounded-md group cursor-pointer'>
                                        <img src='https://serviceapi.spicezgold.com/download/1742462485037_siril-poly-silk-grey-off-white-color-saree-with-blouse-piece-product-images-rvcpwdyagl-2-202304220521.webp' className='w-full transition-all group-hover:scale-105' />
                                    </div>
