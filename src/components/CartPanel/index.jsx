                ...
                <div className="cartItem w-full flex items-center gap-4 border-b border-[rgba(0,0,0,0.1)] pb-4">
                    ...
                    <div className="img w-[25%] overflow-hidden h-[80px] rounded-md">
                        <Link to="product/45875" className='block group'>
                            <img src="https://serviceapi.spicezgold.com/download/1742462485033_siril-poly-silk-grey-off-white-color-saree-with-blouse-piece-product-images-rvcpwdyagl-0-202304220521.webp"
