     ...
     <div className="card bg-white shadow-md rounded-md sticky top-[10px]">
                    <div className="w-full p-5 flex items-center justify-center flex-col">
                        <div className="w-[110px] h-[110px] rounded-full overflow-hidden mb-4 relative group">
                            <img src="https://thumbs.dreamstime.com/b/portrait-happy-ambitious-indian-top-
                            manager-modern-office-businessman-proud-career-achievement-
                            smiling-young-man-339154938.jpg"
                            className="w-full h-full object-cover"/>
                            <div className='overlay w-[100%] h-[100%] absolute
                        ...
                        <h3>Rajesh Sharma</h3>
                        <h6 className="text-[13px] font-[500]">rinkuv37@gmail.com</h6>
